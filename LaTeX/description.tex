...
This method is imperfect, though. While it correctly creates Contours for the model, it also causes 
...
Seeing flaw in the implementation, we moved on to our second implementation. This time, we used the stencil 
